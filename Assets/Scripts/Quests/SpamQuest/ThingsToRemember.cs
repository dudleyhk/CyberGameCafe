...
public class ThingsToRemember : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        theThings[6] = "If you receive an e-mail from someone in your contacts, especially if it's not a close friend,"
            + " and the whole content of the e-mail is just a hyperlink, this is a common indicator that your friend's"
            + " e-mail account has been hacked.You should e-mail the sender to ask if they sent you the e-mail intentionally.";
        ...
        theThings[8] = "If you have an account on a website and you receive an e-mail telling you about changes to your account"
        ...
        theThings[9] = "If an e-mail refers directly to something about you (e.g.a product you bought or an incident in which"
        ...
        theThings[10] = "It is extremely uncommon for someone to win a competition they didn't enter. If you get an e-mail saying"
            + " you won a contest that you didn't enter it is almost always a scam.";

        theThings[11] = "If the content of the e-mail doesn't indicate who the sender is, how they know you or who they represent"
